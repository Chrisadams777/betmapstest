    ...
    <main class="wrapper togglesidebar container-fluid wysiwyg">
        ...
        <section class="color-font-section">
            ...
            <form name="color_palette" id="color_palette" role="form" action="<?=system_getFormAction($_SERVER['PHP_SELF'])?>" method="post">
                ...
                <p><?=str_replace('%link%', '<a href="http://support.edirectory.com/customer/portal/articles/2973912-how-to-change-the-colors?b_id=7909" target=”_blank” rel=”noopener”>'.LANG_SITEMGR_CLICK_HERE.'</a>', LANG_SITEMGR_COLOR_TIP)?></p>
